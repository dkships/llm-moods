-- Rumor candidate precision: keep tracked-model posts that state ETA or
-- enterprise-partner testing ahead of wider launch. Mirrors RUMOR_LEXICON in
-- supabase/functions/_shared/rumor-detect.ts without triggering a reprocess.
