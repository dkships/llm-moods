...
| ~~`scrape-github-issues-3x`~~ | — | — | `scrape-github-issues` **unscheduled 2026-09-01** (39% of classifier volume, 73% irrelevant, negative-only; `github` also excluded from scoring; function + config kept) |
